...
export const CardDotComponent = ({ bookmark }: { bookmark: any }) => {
    ...
    const pin = () => {
        console.log("Pin/Unpin method called");
        if (bookmark.pinned) {
    ...
    return (
        <>
            <button onClick={() => setIsOpen(!isOpen)} className='cursor-pointer dark:focus:outline-neutral-100 focus:outline-2 focus:outline-offset-3 dark:bg-neutral-800 border flex items-center justify-center border-neutral-500 rounded-lg w-8 h-8'>
